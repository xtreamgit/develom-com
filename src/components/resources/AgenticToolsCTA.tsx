...
export default function AgenticToolsCTA() {
  return (
    <section className="bg-[#F8FAFC] px-6 py-24 md:py-32">
      <div className="mx-auto max-w-[680px]">
        ...
        >
          Not Sure Which Stack Fits Your Use Case?
        </h2>
        <p className="mt-5 max-w-[520px] text-[17px] leading-[1.7] text-muted">
          Tell us what you&apos;re building — the workflow, the compliance requirements, the scale.
          We&apos;ll tell you exactly how we&apos;d architect it.
        </p>
